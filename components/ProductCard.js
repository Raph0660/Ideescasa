  ...
  return (
    <article className="group">
      <a href={`/machines/${product.slug}`} className="block">
        ...
        {/* BLOC IMAGE D'ORIGINE RESTAURÉ À 100% */}
        ...
        {/* BLOC TEXTE MIS À JOUR (Ton Commit) */}
        <div className="space-y-1">
          ...
          {/* Modèle humanisé si référence courte */}
          ...
          {/* Description avec min-h pour alignement de la grille */}
